...
do
  python -u run_longExp.py \
      --is_training 1 \
      --is_finetune 1 \
      --finetune_weights '/home/zy/LTSF-Linear-main/checkpoints/dim1_96_96_Informer_dim1_ftM_sl96_ll48_pl96_dm64_nh8_el2_dl1_df256_fc3_ebtimeF_dtTrue_Exp_0/checkpoint.pth' \
      --root_path ./dataset/ \
      --data_path dim2.csv \
      --model_id dim2_96_$pred_len \
      --model $model_name \
      --data dim2 \
      --features M \
      --seq_len 96 \
      ...
      --des 'Exp' \
      --itr 1  >logs/LongForecasting/$model_name'_dim2_'$pred_len.log
done
done
# # python -u run_longExp.py \
# #   --is_training 1 \
